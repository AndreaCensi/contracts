...
np_types = {
    'np_int': np.int64,  # Platform integer (using int64 as replacement for np.int)
    ...
    'np_float': np.float64,  # Shorthand for float64 (using float64 as replacement for np.float)
    ...
    'np_complex': np.complex128,  # Shorthand for complex128 (using complex128 as replacement for np.complex)
