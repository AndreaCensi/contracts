...
class TestIdioms(unittest.TestCase):
    ...
    def test_check_2(self):
        self.assertRaises(ContractNotRespected, check, "tuple(int,int)", (None, 2))

    def test_check_3(self):
        self.assertRaises(ContractSyntaxError, check, "tuple(>>int,int)", (None, 2))
